...
import com.example.demo.repositories.MedicamentoRepositories;

@Service
public class MedicamentoService {

	private final MedicamentoRepositories medicamentoRepository;

	@Autowired
	public MedicamentoService(MedicamentoRepositories medicamentoRepository) {
